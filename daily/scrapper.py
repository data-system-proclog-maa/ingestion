...
if os.getenv("GCP_SA_KEY"):
    ...
    # for local
    with open (dailyScrapperConfig.GCP_SA_KEY, "r", encoding="utf-8") as f:
...
def main():
    ...
    try:
        ...
        bq_sync_map = {
            po_r_path: dailyScrapperConfig.BQ_TABLE_PO_R,
            tl_r_path: dailyScrapperConfig.BQ_TABLE_TL_R,
        }
        DATASET_ID = dailyScrapperConfig.BQ_DATASET
        # sync to bq
        if sync_registry:
            print("\nStarting BQ Sync...")
